      ...
      <div className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              className="border border-gray-200 rounded-lg p-6 text-center hover:shadow-lg transition duration-300"
            >
              ...
              <button
                className="bg-green-600 text-white py-2 px-6 rounded-lg font-semibold hover:bg-green-700 transition duration-300 w-full"
              >
                Get Started
              </button>
            </div>
            <div
              className="border-2 border-green-500 rounded-lg p-6 text-center transform scale-105 hover:shadow-lg transition duration-300 bg-gray-50"
            >
              <div
                className="absolute top-0 right-0 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-bl-lg rounded-tr-lg"
              >
                POPULAR
              </div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800">
