    ...
    <>
      ...
      >
        <div className="flex flex-col items-center space-y-8 text-white text-2xl">
          <a
                href="#home"
                className="py-4 px-2 text-green-500 font-semibold" onClick={() => setIsMenuOpen(false)}
              >
                Home
              </a>
              <a
                href="#services"
                className="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300" onClick={() => setIsMenuOpen(false)}
              >
                Services
              </a>
              <a
